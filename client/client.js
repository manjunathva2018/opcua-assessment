...
console.log("still trying to connect to ", serverUrl, ": retry =", retry, "next attempt in ", delay / 1000, "seconds")
);
    ...
    rl.question('\nAvailable nodes IDs are "ns=1;s=O5D100" and "ns=1;s=VVB001". Enter node ID to read data from: ', async (nodeId) => {
        rl.close();
...
// async function addNodeAndReadData() {
//     try {
